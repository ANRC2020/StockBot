...
global timeframe
timeframe = '52wk' # (1 + 5) + 5 + 5 -> 3 weeks ago
# timeframe = '6d'
...
def setstocks(arr):
    ...
    if(stock.changes[-1] > 0):
        # if(stock.MACD_val[-1] > stock.MACD9_arr[-1] and stock.PSARMatrix[0][7] == 1 and stock.PSARMatrixlong[0][7] == 1):
        if(stock.MACD_val[-1] > stock.MACD9_arr[-1] and stock.PSARMatrix[0][7] == 1 and stock.PSARMatrixlong[0][7] == 1 and stock.momentum_EMA_log[-1] > 0 and stock.momentum_EMA_log[-1] > stock.momentum_EMA_log[-2]):
        # if(stock.momentum_EMA_log[-1] > 0 and stock.momentum_EMA_log[-1] > stock.momentum_EMA_log[-2]):
        # if(stock.PSARMatrix[0][7] == 1 and stock.PSARMatrixlong[0][7] == 1):
        # if((stock.MACD_val[-1] > stock.MACD9_arr[-1] and stock.PSARMatrix[0][7] == 1 and stock.PSARMatrixlong[0][7] == 1 and stock.RSILong[-1] > 50)):
        # if((stock.MACD_val[-1] > stock.MACD9_arr[-1] and stock.PSARMatrix[0][7] == 1 and stock.PSARMatrixlong[0][7] == 1)  or (stock.PSARMatrix[0][7] == 1 and stock.PSARMatrixlong[0][7] == 1) or (stock.RSI[-2] < 30 and stock.RSI[-2] < stock.RSI[-1])):
            # if(stock.EMA_Slope > 0):
                return True 
