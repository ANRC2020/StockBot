    ...
    if(y == 'y' or y == 'Y'):
        ...
        if(y != ''):
            for stock in stocks_list:
                ...
                axis[0].plot(stock.t, stock.close, stock.t, stock.buyindicator, 'og', stock.t, stock.soldindicator, 'or')
                axis[0].set_title("5 min")

                t1 = []
                for i in range(len(stock.anchor15)):
                    t1.append(i)

                axis[1].plot(t1, stock.anchor15,'k')
                axis[1].set_title("15 min")

                t2 = []
                for i in range(len(stock.anchor30)):
                    t2.append(i)

                axis[2].plot(t2, stock.anchor30,'k')
                axis[2].set_title("30 min")
