...
# symbol = ['CLOV','IHT','ASTS','NEXT','AEHL','WISH','RIDE']
    ...
    if check_time.hour >= 0  and check_time.hour >= 0:
        ...
        while(counter < iterations): # set to # of data entires - 2
            ...
            for i in range(stocks):
                ...
                # Enter Checks for selling, and buying
                ...
                elif(stocks_list[i].PSARMatrix[0][7] == 1 and stocks_list[i].PSARMatrixlong[0][7] == 1):
